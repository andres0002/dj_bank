...
## 13. Cargar data desde el panel de admin de django.
### -> Create dos users.
## 14. Cargar data desde el panel de admin de django.
### -> Create ciudades.
## 15. Cargar data desde el panel de admin de django.
### -> Create dos clientes de typo admin, client.
## 16. Desativar el venv.
### -> deactivate